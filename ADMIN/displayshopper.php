    ...
    <table border="2" align="center" cellpadding="12" cellspacing="">
        ...
        while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td><a href="edit_user.php?id=<?php echo $row["id"];?>&action=edit">Edit</a></td>
                <td><a href="delete_user.php?id=<?php echo $row["id"];?>&action=delete" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a></td>
            </tr>
        <?php } ?>
    </table>
