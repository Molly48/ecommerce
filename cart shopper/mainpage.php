...
<script>
        function showProductDetails(productName, price, image) {
            // Redirect to detailproducts.php with query parameters
            window.location.href = "detailproducts.php?productName=" + productName + "&price=" + price + "&image=" + image;
        }
    </script>
</head>
    <style>
...
<div class="container">
    ...
    $query = "SELECT productName, price, image FROM products";
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ?>
            <a href="detailproducts.php" style="text-decoration: none;">
                <div class="card">
