...
<script>
        function showProductDetails(productName, price, image) {
            ...
            window.location.href = "detailproductsmain.php?productName=" + productName + "&price=" + price + "&image=" + image;
        }
    </script>
</head>
    <style>
...
<div class="container" id="productList">
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ?>
            <a href="detailproductsmain.php?prod_id=<?php echo $row["id"]; ?>" style="text-decoration: none;">
                <div class="card">
